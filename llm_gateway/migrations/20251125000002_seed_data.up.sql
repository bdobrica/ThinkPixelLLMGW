...
-- ============================================================================
-- Seed: Demo Model Aliases
-- ============================================================================
INSERT INTO model_aliases (id, alias, target_model_id, provider_id, enabled) VALUES
    ('77777777-7777-7777-7777-777777777777', 'gpt-4', '22222222-2222-2222-2222-222222222222', '11111111-1111-1111-1111-111111111111', true),
    ('88888888-8888-8888-8888-888888888888', 'gpt4-mini', '33333333-3333-3333-3333-333333333333', '11111111-1111-1111-1111-111111111111', true),
    ('99999999-9999-9999-9999-999999999999', 'reasoning', '44444444-4444-4444-4444-444444444444', '11111111-1111-1111-1111-111111111111', true);

-- ============================================================================
-- Seed: Demo Model Alias Tags
-- ============================================================================
INSERT INTO model_alias_tags (model_alias_id, key, value) VALUES
    ('77777777-7777-7777-7777-777777777777', 'category', 'premium'),
    ('77777777-7777-7777-7777-777777777777', 'use_case', 'general'),
    ('88888888-8888-8888-8888-888888888888', 'category', 'cost-effective'),
    ('88888888-8888-8888-8888-888888888888', 'use_case', 'high-volume'),
    ('99999999-9999-9999-9999-999999999999', 'category', 'advanced'),
    ('99999999-9999-9999-9999-999999999999', 'use_case', 'complex-reasoning');
